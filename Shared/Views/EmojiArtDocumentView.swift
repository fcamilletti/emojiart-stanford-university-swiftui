...
struct EmojiArtDocumentView: View {
    ...
    var documentBody: some View {
        GeometryReader { geometry in
            ...
            .alert("Delete selected Emojis?", isPresented: $showDeleteAlert, presenting: deleteEmoji) { deleteEmoji in
    ...
    // MARK: - Panning Document/Dragging Emoji
